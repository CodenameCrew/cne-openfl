...
class CanvasGraphics
{
	...
	@:noCompletion private static inline var KAPPA = 0.5522848;
	...
	@:noCompletion private static function drawRoundRect(x:Float, y:Float, width:Float, height:Float, ellipseWidth:Float, ellipseHeight:Null<Float>, ?scale9Grid:Rectangle,
	...
	@:noCompletion private static function drawEllipse(x:Float, y:Float, width:Float, height:Float, ?scale9Grid:Rectangle, ?bounds:Rectangle, ?scaleX:Float,
			?scaleY:Float):Void
	{
		#if (js && html5)
	...
	@:noCompletion private static function drawCircle(x:Float, y:Float, radius:Float, ?scale9Grid:Rectangle, ?bounds:Rectangle, ?scaleX:Float, ?scaleY:Float):Void
	{
		#if (js && html5)
		if (radius == 0.0)
		{
