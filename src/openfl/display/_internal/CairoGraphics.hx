...
class CairoGraphics
{
	...
	@:noCompletion private static var KAPPA = 0.5522848;
	...
	@:noCompletion private static var hitTestBitmap:BitmapData;
	@:noCompletion private static var hitTestCairo:Cairo;
